...
본 프로젝트에서 저는 **API 테스트 자동화와 성능 테스트 체계 설계**를 중심으로 기여했습니다.<br>
API/성능/E2E 세 분야의 '네트워크', '병렬파일시스템' 도메인 담당으로서 공통 작업+개인작업을 진행했습니다.<br>
<br>
특히 핵심 기여한 영역입니다.
...
**기여 내용**
- OAuth 인증 흐름을 분석하여 토큰 발급 로직을 분리<br>
- 발급된 토큰을 .env에 저장하고 pytest fixture로 공통 사용<br>
- 토큰 만료 시 재발급 가능하도록 구조 설계<br>

**결과**
- API 테스트 간 인증 의존성 제거<br>
- 테스트 재사용성과 실행 안정성 확보<br>

</details>

<details>
<summary>테스트 코드와 실행 환경을 분리하기 위한 환경 변수 표준화</summary>
