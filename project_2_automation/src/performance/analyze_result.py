...
AVG_MS_THRESHOLD = 1000
P95_MS_THRESHOLD = 2000
MAX_MS_THRESHOLD = 3000
TOTAL_TPS_THRESHOLD = 90     ##로그 출력용 기준값
GET_TPS_THRESHOLD = 100
...
def verify_jtl(jtl_path: str) -> None:
    ...
    assert avg < AVG_MS_THRESHOLD, f"Average response time too high: {avg:.2f}ms"
    assert p95 < P95_MS_THRESHOLD, f"P95 too high: {p95:.2f}ms"
